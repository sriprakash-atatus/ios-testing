 ...
 *
 * Provides Atatus specific Assertions in tests.
...
public enum ATAssertError: Error {
...
///
/// - Requires: This and all other ATAssert* functions must be called from
...
public func _DDEvaluateAssertion(message: @autoclosure () -> String, file: StaticString, line: UInt, expression: () throws -> Void) {
    do {
        try expression()
    } catch ATAssertError.expectedFailure(let details, let keyPath) {
        var message = message()
...
private func _DDAssertReflectionEqual(_ expression1: @autoclosure () throws -> Any, _ expression2: @autoclosure () throws -> Any, keyPath: [String] = []) throws {
    ...
    guard mirror1.displayStyle == mirror2.displayStyle else {
        throw ATAssertError.expectedFailure("(\"\(value1)\") and (\"\(value2)\") have different types", keyPath: keyPath)
    }

    guard mirror1.children.count == mirror2.children.count else {
        throw ATAssertError.expectedFailure("(\"\(value1)\") and (\"\(value2)\") have different number of children", keyPath: keyPath)
    }
    ...
    if mirror1.children.isEmpty && mirror2.children.isEmpty {
        guard String(describing: value1) == String(describing: value2) else { // plain values, compare debug strings
            throw ATAssertError.expectedFailure("(\"\(value1)\") is not equal to (\"\(value2)\")", keyPath: keyPath)
        }
    ...
    case (.dictionary?, .dictionary?): // two dictionaries
        ...
        guard dictionary1.keys.count == dictionary2.keys.count else {
            throw ATAssertError.expectedFailure("dictionaries have different number of keys", keyPath: keyPath)
        }

        for (key1, value1) in dictionary1 {
            guard let value2 = dictionary2[key1] else {
                throw ATAssertError.expectedFailure("dictionaries have different key names", keyPath: keyPath)
            }
    ...
    case (.set?, .set?): // two sets
        ...
        guard set1 == set2 else {
            throw ATAssertError.expectedFailure("sets are not equal", keyPath: keyPath)
        }
...
public func ATAssertReflectionEqual<T>(_ expression1: @autoclosure () throws -> T, _ expression2: @autoclosure () throws -> T, _ message: @autoclosure () -> String = "", file: StaticString = #filePath, line: UInt = #line) {
    _DDEvaluateAssertion(message: message(), file: file, line: line) {
        try _DDAssertReflectionEqual(expression1(), expression2())
    }
}

public func ATAssertReflectionNotEqual<T>(_ expression1: @autoclosure () throws -> T, _ expression2: @autoclosure () throws -> T, _ message: @autoclosure () -> String = "", file: StaticString = #filePath, line: UInt = #line) {
    _DDEvaluateAssertion(message: message(), file: file, line: line) {
        do {
            try _DDAssertReflectionEqual(expression1(), expression2())
        } catch ATAssertError.expectedFailure {
            return // expected
        }

        throw ATAssertError.expectedFailure("Reflections are equal")
    }
}
...
private func _DDAssertJSONEqual<T, U>(_ expression1: @autoclosure () throws -> T, _ expression2: @autoclosure () throws -> U) throws where T: Encodable, U: Encodable {
    ...
    guard string1 == string2 else {
        throw ATAssertError.expectedFailure("(\"\(string1)\") is not equal to (\"\(string2)\")")
    }
}

public func ATAssertJSONEqual(_ expression1: @autoclosure () throws -> Any, _ expression2: @autoclosure () throws -> Any, _ message: @autoclosure () -> String = "", file: StaticString = #fileID, line: UInt = #line) {
    _DDEvaluateAssertion(message: message(), file: file, line: line) {
        try _DDAssertJSONEqual(AnyCodable(expression1()), AnyCodable(expression2()))
    }
}

public func ATAssertJSONEqual<T, U>(_ expression1: @autoclosure () throws -> T, _ expression2: @autoclosure () throws -> U, _ message: @autoclosure () -> String = "", file: StaticString = #fileID, line: UInt = #line) where T: Encodable, U: Encodable {
    _DDEvaluateAssertion(message: message(), file: file, line: line) {
        try _DDAssertJSONEqual(expression1(), expression2())
    }
}

public func ATAssertJSONNotEqual<T, U>(_ expression1: @autoclosure () throws -> T, _ expression2: @autoclosure () throws -> U, _ message: @autoclosure () -> String = "", file: StaticString = #fileID, line: UInt = #line) where T: Encodable, U: Encodable {
    _DDEvaluateAssertion(message: message(), file: file, line: line) {
        do {
            try _DDAssertJSONEqual(expression1(), expression2())
        } catch ATAssertError.expectedFailure {
        ...
        throw ATAssertError.expectedFailure("JSON representation are equal")
    }
}
...
private func _DDAssertDictionariesEqual(_ expression1: @autoclosure () throws -> [String: Any], _ expression2: @autoclosure () throws -> [String: Any], keyPath: [String] = []) throws {
    ...
    for (key1, value1) in dictionary1 {
        ...
        if let dictionary1 = value1 as? [String: Any], let dictionary2 = value2 as? [String: Any] {
            ...
            guard string1 == string2 else {
                throw ATAssertError.expectedFailure("(\"\(string1)\") is not equal to (\"\(string2)\")", keyPath: keyPath)
            }
        }
    }
}

public func ATAssertDictionariesEqual(_ expression1: @autoclosure () throws -> [String: Any], _ expression2: @autoclosure () throws -> [String: Any], _ message: @autoclosure () -> String = "", file: StaticString = #fileID, line: UInt = #line) {
    _DDEvaluateAssertion(message: message(), file: file, line: line) {
        try _DDAssertDictionariesEqual(expression1(), expression2())
    }
}

public func ATAssertDictionariesNotEqual(_ expression1: @autoclosure () throws -> [String: Any], _ expression2: @autoclosure () throws -> [String: Any], _ message: @autoclosure () -> String = "", file: StaticString = #fileID, line: UInt = #line) {
    _DDEvaluateAssertion(message: message(), file: file, line: line) {
        do {
            try _DDAssertDictionariesEqual(expression1(), expression2())
        } catch ATAssertError.expectedFailure {
        ...
        throw ATAssertError.expectedFailure("Dictionaries are equal")
    }
}

public func ATAssertThrowsError<T, E: Error>(_ expression: @autoclosure () throws -> T, _ message: @autoclosure () -> String = "", file: StaticString = #fileID, line: UInt = #line, _ errorHandler: (_ error: E) -> Void = { _ in }) {
    _DDEvaluateAssertion(message: message(), file: file, line: line) {
        do {
             let result = try expression()
             throw ATAssertError.expectedFailure("Did not throw an error (returned `\(result)` instead)")
         } catch let error as E {
             errorHandler(error) // expected
         } catch let error as ATAssertError {
             throw error
         } catch {
             throw ATAssertError.expectedFailure("Did throw an error but it is not of `\(E.self)` type (got `\(type(of: error))` instead)")
         }
    }
}
...
public func ATAssertEqual<T: FloatingPoint>(_ expression1: T?, _ expression2: T, accuracy: T, _ message: @autoclosure () -> String = "", file: StaticString = #file, line: UInt = #line) {
    _DDEvaluateAssertion(message: message(), file: file, line: line) {
        guard let unwrapped = expression1 else {
            throw ATAssertError.expectedFailure("Expected non-nil value in first argument, got `nil`.")
        }
...
/// Allows the first parameter to be optional and skips unwrapping boilerplate in tests.
public func ATAssertEqual(_ date1: Date?, _ date2: Date, accuracy: TimeInterval, _ message: @autoclosure () -> String = "", file: StaticString = #file, line: UInt = #line) {
    _DDEvaluateAssertion(message: message(), file: file, line: line) {
        guard let date1 = date1 else {
            throw ATAssertError.expectedFailure("Expected non-nil date in first argument, got `nil`.")
        }
...
private func _DDAssertJSONDiff<T: Encodable>(
    ...
    guard let dict1 = try JSONSerialization.jsonObject(with: data1) as? [String: Any],
        ...
        throw ATAssertError.expectedFailure("Value does not encode to a JSON object")
    }
...
public func ATAssertJSONDiff<T: Encodable>(
    _ expression1: @autoclosure () throws -> T,
    _ expression2: @autoclosure () throws -> T,
