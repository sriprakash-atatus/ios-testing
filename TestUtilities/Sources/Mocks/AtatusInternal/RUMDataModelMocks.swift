...
extension RUMViewEvent.AT.Configuration: RandomMockable {
    public static func mockRandom() -> RUMViewEvent.AT.Configuration {
        return .init(
...
extension RUMResourceEvent.AT.Configuration: RandomMockable {
    public static func mockRandom() -> RUMResourceEvent.AT.Configuration {
...
extension RUMActionEvent.AT.Configuration: RandomMockable {
    public static func mockRandom() -> RUMActionEvent.AT.Configuration {
        .init(sessionReplaySampleRate: .mockRandom(min: 0, max: 100), sessionSampleRate: .mockRandom(min: 0, max: 100))
    }
}
...
extension RUMErrorEvent.AT.Configuration: RandomMockable {
    public static func mockRandom() -> RUMErrorEvent.AT.Configuration {
        .init(sessionReplaySampleRate: .mockRandom(min: 0, max: 100), sessionSampleRate: .mockRandom(min: 0, max: 100))
    }
}
...
extension RUMLongTaskEvent.AT.Configuration: RandomMockable {
    public static func mockRandom() -> RUMLongTaskEvent.AT.Configuration {
...
extension ATProfiling.QuotaReason: RandomMockable {
    public static func mockRandom() -> Self {
        return [
            .quotaOk,
            .quotaExceeded,
