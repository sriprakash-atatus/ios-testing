...
// -> `AtatusLogs`; renamed `dd*` members to `at*`; renamed the build `variant` to `appName`; rebranded the
// licence header.
...
extension LogEvent: AnyMockable, RandomMockable {
    ...
    public static func mockWith(
        ...
        atTags: String = .mockRandomDDTags(),
        tags: [String]? = nil
    ) -> LogEvent {
        return LogEvent(
            date: date,
