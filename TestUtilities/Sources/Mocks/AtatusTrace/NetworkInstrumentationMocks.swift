...
public final class URLSessionHandlerMock: AtatusURLSessionHandler {
...
extension TrackingMode: AnyMockable, RandomMockable {
    public static func mockAny() -> AtatusInternal.TrackingMode {
        return .automatic
    }

    public static func mockRandom() -> AtatusInternal.TrackingMode {
