...
#define AT_PROFILER_PROFILER_H_
...
// MARK: - AT Profiler (auto-start) API

/**
 * Status codes for the dd profiler operations
 */
typedef enum {
    AT_PROFILER_STATUS_NOT_CREATED = 0,       ///< Profiler was not created
    AT_PROFILER_STATUS_NOT_STARTED = 1,       ///< Profiler was never started
    AT_PROFILER_STATUS_RUNNING = 2,           ///< Profiler is currently running
    AT_PROFILER_STATUS_STOPPED = 3,           ///< Profiler was stopped manually
    AT_PROFILER_STATUS_TIMEOUT = 4,           ///< Profiler was stopped due to timeout
    AT_PROFILER_STATUS_PREWARMED = 5,         ///< Profiler was not started due to prewarming
    AT_PROFILER_STATUS_ALLOCATION_FAILED = 6, ///< Memory allocation failed
 ...
 *
 * After calling this function, `dd_profiler_get_status()` will return `AT_PROFILER_STATUS_STOPPED`.
 *
