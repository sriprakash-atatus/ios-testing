...
// `ddMachProfiler` -> `AtatusMachProfiler`; renamed the `DD` symbol prefix to `AT`; rebranded the
// licence header.
...
extension ProfilingHandler {
    @discardableResult
    func updateProfilingContext(quotaReason: ATProfiling.QuotaReason? = nil) -> ProfilingContext {
