...
public struct HeatmapAttributes: Equatable {
    ...
    public init(identifier: HeatmapIdentifier, size: CGSize, location: CGPoint) {
        ...
        self.targetWidth = Int64.atWithNoOverflow(size.width)
        self.targetHeight = Int64.atWithNoOverflow(size.height)
        self.positionX = Int64.atWithNoOverflow(location.x)
        self.positionY = Int64.atWithNoOverflow(location.y)
    }
}
