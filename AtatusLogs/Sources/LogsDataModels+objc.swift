...
@objc(ATLogEventOperatingSystem)
@objcMembers
@_spi(objc)
...
@objc(ATLogEventDeviceDeviceType)
@_spi(objc)
...
@objc(ATLogEventNetworkConnectionInfo)
@objcMembers
@_spi(objc)
...
@objc(ATLogEventRadioAccessTechnology)
@_spi(objc)
