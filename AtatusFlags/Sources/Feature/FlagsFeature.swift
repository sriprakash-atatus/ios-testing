    ...
    init(
        ...
        evaluationAggregator = configuration.trackEvaluations ? {
            ...
            if flushInterval < Constants.minEvaluationFlushInterval {
                AT.logger.warn("`Flags.Configuration.evaluationFlushInterval` cannot be less than \(Constants.minEvaluationFlushInterval)s. A value of \(Constants.minEvaluationFlushInterval)s will be used.")
                flushInterval = Constants.minEvaluationFlushInterval
            } else if flushInterval > Constants.maxEvaluationFlushInterval {
                AT.logger.warn("`Flags.Configuration.evaluationFlushInterval` cannot exceed \(Constants.maxEvaluationFlushInterval)s. A value of \(Constants.maxEvaluationFlushInterval)s will be used.")
