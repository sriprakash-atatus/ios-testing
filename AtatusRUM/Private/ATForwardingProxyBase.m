...
// ATCHG: Atatus SDK migration - renamed the `DD` symbol prefix to `AT`; renamed the `__dd_private_*` ObjC
// symbols to `__atatus_private_*`; rebranded the licence header.

#import <Foundation/Foundation.h>
#import <objc/runtime.h>
#import "ATForwardingProxyBase.h"

#if TARGET_OS_IOS || TARGET_OS_VISION
#import <UIKit/UIKit.h>
#endif

@implementation __atatus_private_DDForwardingProxyBase
