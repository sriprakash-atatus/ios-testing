...
class RUMViewsHandlerTests: XCTestCase {
    ...
    func testWhenOnAppear_itStartsRUMView() throws {
        ...
        ATAssertDictionariesEqual(command.attributes, viewAttributes)
    }
    ...
    func testWhenOnAppear_itStopsPreviousRUMView() throws {
        ...
        ATAssertDictionariesEqual(startCommand1.attributes, view1Attributes)
        ...
        ATAssertDictionariesEqual(startCommand2.attributes, view2Attributes)
    }
    ...
    func testGivenAppearedView_whenOnDisappear_itSopsTheRUMView() throws {
        ...
        ATAssertDictionariesEqual(startCommand.attributes, viewAttributes)
