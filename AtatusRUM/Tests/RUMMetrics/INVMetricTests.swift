...
class INVMetricTests: XCTestCase {
    ...
    func testWhenComputingMetricValue_itCallsPredicateWithAllActionsFromPreviousView() throws {
        ...
        ATAssertReflectionEqual(actionsInPredicate[0], INVActionParams(type: .tap, name: "Action 1C", timeToNextView: 7, nextViewName: "View 2"))
        ATAssertReflectionEqual(actionsInPredicate[1], INVActionParams(type: .tap, name: "Action 1B", timeToNextView: 8, nextViewName: "View 2"))
        ATAssertReflectionEqual(actionsInPredicate[2], INVActionParams(type: .tap, name: "Action 1A", timeToNextView: 9, nextViewName: "View 2"))
        ATAssertReflectionEqual(actionsInPredicate[3], INVActionParams(type: .tap, name: "Action 2B", timeToNextView: 8, nextViewName: "View 3"))
        ATAssertReflectionEqual(actionsInPredicate[4], INVActionParams(type: .tap, name: "Action 2A", timeToNextView: 9, nextViewName: "View 3"))
    }
