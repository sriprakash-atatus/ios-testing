...
class RUMViewScopeTests: XCTestCase {
    ...
    func testWhenInitialViewReceivesAnyCommand_itSendsViewUpdateEvent() throws {
        ...
        ATTAssertValidRUMUUID(event.view.id)
    ...
    func testWhenViewAttributesAreSet_nextEventsHaveThem() throws {
        ...
        ATAssertDictionariesEqual(scope.attributes, ["viewKey": "viewValue"])
        ATAssertDictionariesEqual(event.context!.contextInfo, ["viewKey": "viewValue"])
        ...
        ATAssertDictionariesEqual(scope.attributes, ["viewKey": "viewValue", "newViewKey": "newViewValue", "anotherKey": "anotherValue"])
        ATAssertDictionariesEqual(event.context!.contextInfo, ["viewKey": "viewValue", "newViewKey": "newViewValue", "anotherKey": "anotherValue"])
    }
    ...
    func testWhenViewAttributesAreRemoved_eventsDoNotIncludeThem() throws {
        ...
        // Then
        event = try XCTUnwrap(writer.events(ofType: RUMViewEvent.self).last)
        ATAssertDictionariesEqual(scope.attributes, [:])
        ATAssertDictionariesEqual(event.context!.contextInfo, [:])
    }
    ...
    func testWhenInternalViewAttributesAreSet_eventsAreNotAffected() throws {
        ...
        var event = try XCTUnwrap(writer.events(ofType: RUMViewEvent.self).last)
        ATAssertDictionariesEqual(scope.attributes, ["viewKey": "viewValue"])
        ATAssertDictionariesEqual(scope.internalAttributes, ["internalKey": "internalValue"])
        ATAssertDictionariesEqual(event.context!.contextInfo, ["viewKey": "viewValue"])
        ...
        // Then
        event = try XCTUnwrap(writer.events(ofType: RUMViewEvent.self).last)
        ATAssertDictionariesEqual(scope.attributes, ["viewKey": "newViewValue"])
        ATAssertDictionariesEqual(scope.internalAttributes, ["internalKey": "internalValue"])
        ATAssertDictionariesEqual(event.context!.contextInfo, ["viewKey": "newViewValue"])
    }
    ...
    func testWhenViewAttributesAreSet_childEventsHaveThem() throws {
        ...
        ATAssertDictionariesEqual(scope.attributes, ["viewKey": "viewValue"])
        ATAssertDictionariesEqual(viewEvent.context!.contextInfo, ["viewKey": "viewValue"])
        ...
        ATAssertDictionariesEqual(scope.attributes, ["viewKey": "viewValue"])
        ATAssertDictionariesEqual(viewEvent.context!.contextInfo, ["viewKey": "viewValue", "globalKey": "globalValue"])
        ATAssertDictionariesEqual(actionEvent.context!.contextInfo, ["viewKey": "viewValue", "globalKey": "globalValue", "localKey": "localValue"])
        ...
        ATAssertDictionariesEqual(scope.attributes, ["viewKey": "viewValue", "newViewKey": "newViewValue"])
        ATAssertDictionariesEqual(viewEvent.context!.contextInfo, ["viewKey": "viewValue", "newViewKey": "newViewValue", "globalKey": "globalValue"])
        ATAssertDictionariesEqual(
    ...
    func testWhenViewAttributesCollide_thePrecedenceIsRespected() throws {
        ...
        // Then
        var viewEvent = try XCTUnwrap(writer.events(ofType: RUMViewEvent.self).last)
        ATAssertDictionariesEqual(scope.attributes, ["key": "viewValue"])
        ATAssertDictionariesEqual(viewEvent.context!.contextInfo, ["key": "viewValue"])
        ...
        ATAssertDictionariesEqual(scope.attributes, ["key": "viewValue"])
        ATAssertDictionariesEqual(viewEvent.context!.contextInfo, ["key": "viewValue"])
        ATAssertDictionariesEqual(actionEvent.context!.contextInfo, ["key": "localValue"])
        ...
        ATAssertDictionariesEqual(scope.attributes, ["key": "viewValue"])
        ATAssertDictionariesEqual(viewEvent.context!.contextInfo, ["key": "viewValue"])
        ATAssertDictionariesEqual(resourceEvent.context!.contextInfo, ["key": "resourceValue"])
    }
    ...
    func testWhenViewAttributesChangeOnStoppedViewWithActiveResources() throws {
        ...
        ATAssertDictionariesEqual(firstViewScope.attributes, ["viewKey": "viewValue"])
        ATAssertDictionariesEqual(view1Event.context!.contextInfo, ["viewKey": "viewValue", "globalKey": "globalValue"])
        ...
        ATAssertDictionariesEqual(firstViewScope.attributes, ["viewKey": "viewValue", "newViewKey": "newViewValue", "globalKey": "globalValue"])
        ATAssertDictionariesEqual(secondViewScope.attributes, ["view2Key": "view2Value"])
        ATAssertDictionariesEqual(view1Event.context!.contextInfo, ["viewKey": "viewValue", "newViewKey": "newViewValue", "globalKey": "globalValue"])
        ATAssertDictionariesEqual(view2Event.context!.contextInfo, ["view2Key": "view2Value", "globalKey": "globalValue"])
        ...
        // First view scope is inactive with the final snapshot of attributes
        ATAssertDictionariesEqual(firstViewScope.attributes, ["viewKey": "viewValue", "newViewKey": "newViewValue", "globalKey": "globalValue"])
        ATAssertDictionariesEqual(secondViewScope.attributes, ["view2Key": "view2Value", "newView2Key": "newView2Value"])
        ATAssertDictionariesEqual(
    ...
    func testWhenGlobalAttributesAreUpdated_eventsHaveTheUpdate() throws {
        ...
        var event = try XCTUnwrap(writer.events(ofType: RUMViewEvent.self).last)
        ATAssertDictionariesEqual(scope.attributes, ["viewKey": "viewValue"])
        ATAssertDictionariesEqual(event.context!.contextInfo, ["globalKey": "globalValue", "viewKey": "viewValue"])
        ...
        ATAssertDictionariesEqual(scope.attributes, ["viewKey": "newViewValue", "globalKey": "newGlobalValue"])
        ATAssertDictionariesEqual(event.context!.contextInfo, ["globalKey": "newGlobalValue", "viewKey": "newViewValue"])
    }
    ...
    func testViewAttributesTakePrecedenceOverGlobalAttributes() throws {
        ...
        var event = try XCTUnwrap(writer.events(ofType: RUMViewEvent.self).last)
        ATAssertDictionariesEqual(scope.attributes, ["key": "viewValue"])
        ATAssertDictionariesEqual(event.context!.contextInfo, ["key": "viewValue"])
        ...
        // Then
        event = try XCTUnwrap(writer.events(ofType: RUMViewEvent.self).last)
        ATAssertDictionariesEqual(scope.attributes, ["key": "newViewValue"])
        ATAssertDictionariesEqual(event.context!.contextInfo, ["key": "newViewValue"])
    }
    ...
    func testCommandAttributesTakePrecendenceOverViewAttributesAndGlobalAttributes() throws {
        ...
        ATAssertDictionariesEqual(scope.attributes, ["key": "viewValue"])
        ATAssertDictionariesEqual(longTaskEvent.context!.contextInfo, ["key": "localValue"])
    ...
    func testWhenRemovingGlobalAttributes_eventsDoNotIncludeThem() throws {
        ...
        var event = try XCTUnwrap(writer.events(ofType: RUMViewEvent.self).last)
        ATAssertDictionariesEqual(scope.attributes, ["key": "viewValue"])
        ATAssertDictionariesEqual(event.context!.contextInfo, ["key": "viewValue", "globalKey": "globalValue"])
        ...
        // Then
        event = try XCTUnwrap(writer.events(ofType: RUMViewEvent.self).last)
        ATAssertDictionariesEqual(scope.attributes, ["key": "viewValue", "anotherViewKey": "anotherViewValue"])
        ATAssertDictionariesEqual(event.context!.contextInfo, ["key": "viewValue", "anotherViewKey": "anotherViewValue"])
        ...
        // Then
        event = try XCTUnwrap(writer.events(ofType: RUMViewEvent.self).last)
        ATAssertDictionariesEqual(scope.attributes, ["key": "newViewValue", "anotherViewKey": "anotherViewValue"])
        ATAssertDictionariesEqual(event.context!.contextInfo, ["key": "newViewValue", "anotherViewKey": "anotherViewValue"])
    }
    ...
    func testWhenViewErrorIsAdded_itSendsErrorEventAndViewUpdateEvent() throws {
        ...
        ATTAssertValidRUMUUID(error.view.id)
        ...
        ATTAssertValidRUMUUID(error.error.id)
    ...
    func testGivenStartedView_whenErrorWithAttributesIsAdded_itDoesNotUpdateViewAttributes() throws {
        ...
        let error = try XCTUnwrap(writer.events(ofType: RUMErrorEvent.self).last)
        ATAssertDictionariesEqual(error.context!.contextInfo, ["test_attribute": "abc", "other_attribute": "overwritten", "foo": "bar"])
    ...
    func testWhenThereAreHitches_theViewUpdatesContainsSlowFrames() {
        ...
        let hitchesDuration = TimeInterval.atFromNanoseconds( hitches.map { $0.duration }.reduce(0, +))
    ...
    func testWhenLongTaskIsAdded_itSendsLongTaskEventAndViewUpdateEvent() throws {
        ...
        XCTAssertEqual(event.source, .ios)
        ATTAssertValidRUMUUID(event.longTask.id)
    ...
    func testGivenStartedView_whenLongTaskWithAttributesIsAdded_itDoesNotUpdateViewAttributes() throws {
        ...
        let event = try XCTUnwrap(writer.events(ofType: RUMLongTaskEvent.self).last)
        ATAssertDictionariesEqual(event.context!.contextInfo, ["foo": "bar", "test_attribute": "overwritten", "other_attribute": "my attribute"])
        ATAssertDictionariesEqual(scope.attributes, ["test_attribute": "abc", "other_attribute": "my attribute"])
    }
    ...
    func testWhenViewIsStarted_itUpdatesFatalErrorContextWithView() throws {
        ...
        ATAssertReflectionEqual(rumViewWritten, rumViewInFatalErrorContext, "It must update fatal error context with the view event written")
    }
    ...
    func testWhenInactiveViewEmitsTerminalEventAfterStopResource_itDoesNotOverwriteFatalErrorContext() throws {
        ...
        ATAssertReflectionEqual(finalView, snapshotForB, "Inactive view's terminal event must not overwrite the active view in fatal error context")
    }
