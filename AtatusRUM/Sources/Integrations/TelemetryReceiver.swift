...
internal final class TelemetryReceiver: FeatureMessageReceiver {
    ...
    /// see. https://github.com/dd/rum-events-format/blob/master/schemas/telemetry/debug-schema.json
    ///
    ...
    /// see. https://github.com/dd/rum-events-format/blob/master/schemas/telemetry/error-schema.json
    ///
    /// The current RUM context info is applied if available, including session ID, view ID,
    /// and action ID.
    ///
