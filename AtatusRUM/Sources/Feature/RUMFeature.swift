...
internal final class RUMFeature: AtatusRemoteFeature, RUMSessionSamplerProvider {
    ...
    init(
        ...
        core.telemetry.configuration(
            ...
            sessionSampleRate: Int64.atWithNoOverflow(configuration.debugSDK ? 100 : configuration.sessionSampleRate),
            telemetrySampleRate: Int64.atWithNoOverflow(configuration.debugSDK ? 100 : configuration.telemetrySampleRate),
            tnsTimeThresholdMs: configuration.networkSettledResourcePredicate.tnsTimeThresholdMs,
            traceSampleRate: configuration.urlSessionTracking?.firstPartyHostsTracing.map { Int64.atWithNoOverflow($0.sampleRate) },
