...
tracked_files:
  - AtatusRUM/Sources/RUM.swift
  - AtatusRUM/Sources/RUMConfiguration.swift
  - AtatusRUM/Sources/RUMMonitor.swift
  - AtatusRUM/Sources/RUMMonitorProtocol.swift
---
...
### Feature Entry Point
- **`AtatusRUM/Sources/RUM.swift`** - Main entry point. Call `RUM.enable(with:)` to activate the feature.

### Configuration
- **`AtatusRUM/Sources/RUMConfiguration.swift`** - All configuration options available to customers.
...
### Public API
- **`AtatusRUM/Sources/RUMMonitor.swift`** - Access point for manual RUM tracking via `RUMMonitor.shared()`
- **`AtatusRUM/Sources/RUMMonitorProtocol.swift`** - Full API for manual RUM instrumentation
...
### Implementation
- **`AtatusRUM/Sources/Feature/RUMFeature.swift`** - Internal feature implementation. Shows how configuration translates to behavior.
