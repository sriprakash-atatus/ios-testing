    ...
    func write<T: Encodable, M: Encodable>(value: T, metadata: M?, completion: @escaping CompletionHandler) {
        ...
        if let metadata = metadata {
            do {
                ...
                AT.logger.error("(\(orchestrator.trackName)) Failed to encode metadata", error: error)
        ...
        do {
            ...
            AT.logger.error("(\(orchestrator.trackName)) Failed to encode value", error: error)
        ...
        do {
            ...
            AT.logger.error("(\(orchestrator.trackName)) Failed to get writable file for \(writeSize) bytes", error: error)
        ...
        do {
            ...
            AT.logger.error("(\(orchestrator.trackName)) Failed to write \(writeSize) bytes to file", error: error)
