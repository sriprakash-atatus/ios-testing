...
class CrashReportReceiverTests: XCTestCase {
    ...
    func testReceiveCrashAndViewEvent() throws {
        ...
        let message: FeatureMessage = .payload(
            Crash(
                report: ATCrashReport.mockWith(date: Date()),
    ...
    func testGivenCrashDuringRUMSessionWithActiveViewCollectedLessThan4HoursAgo_whenSending_itSendsBothRUMErrorAndRUMViewEvent() throws {
        ...
        let crashReport: ATCrashReport = .mockWith(date: crashDate)
    ...
    func testGivenCrashDuringRUMSessionWithActiveView_whenSendingRUMViewEvent_itIsLinkedToPreviousRUMSessionAndIncludesErrorInformation() throws {
        ...
        ATAssertJSONEqual(sendRUMViewEvent.connectivity, lastRUMViewEvent.connectivity)
        ATAssertJSONEqual(sendRUMViewEvent.usr, lastRUMViewEvent.usr)
        XCTAssertEqual(
        ...
        ATAssertReflectionEqual(sendRUMViewEvent.device, lastRUMViewEvent.device)
        ATAssertReflectionEqual(sendRUMViewEvent.os, lastRUMViewEvent.os)
    }
    ...
    func testGivenCrashDuringRUMSessionWithActiveView_whenSendingRUMErrorEvent_itIsLinkedToPreviousRUMSessionAndIncludesCrashInformation() throws {
        ...
        // Given
        let crashDate: Date = .mockDecember15th2019At10AMUTC()
        let crashReport: ATCrashReport = .mockWith(
            date: crashDate,
        ...
        ATAssertJSONEqual(sendRUMErrorEvent.error.threads, crashReport.threads)
        ATAssertJSONEqual(sendRUMErrorEvent.error.binaryImages, crashReport.binaryImages)
        ATAssertJSONEqual(sendRUMErrorEvent.error.meta, crashReport.meta)
        ATAssertJSONEqual(sendRUMErrorEvent.error.wasTruncated, crashReport.wasTruncated)
    }
    ...
    func testGivenCrashDuringRUMSessionWithActiveViewAndLastRUMAttributesAvailable_itSendsEventsWithOverridingAttributes() throws {
        ...
        ATAssertJSONEqual(sentRUMViewAttributes, lastRUMAttributes)
        ATAssertJSONEqual(sentRUMErrorAttributes, lastRUMAttributes)
    }
