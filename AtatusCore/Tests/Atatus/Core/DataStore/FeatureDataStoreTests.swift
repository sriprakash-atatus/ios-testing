...
class FeatureDataStoreTests: XCTestCase {
    ...
    func testSetAndGetValue() {
        ...
        // Then
        ATAssertReflectionEqual(result, .value("value".utf8Data, dataStoreDefaultKeyVersion))
    ...
    func testGetNoValue() {
        ...
        ATAssertReflectionEqual(result, .noValue)
    }
    ...
    func testSetValueWithCustomVersion() {
        ...
        ATAssertReflectionEqual(result, .value("value".utf8Data, 42))
    ...
    func testUpdateValueWithDifferentVersion() {
        ...
        ATAssertReflectionEqual(result, .value("value v2".utf8Data, 2))
    ...
    func testEachFeatureHasIndependentStore() {
        ...
        // Then
        ATAssertReflectionEqual(results[0].data(), "value A".utf8Data)
        ATAssertReflectionEqual(results[1].data(), "value B".utf8Data)
    }
    ...
    func testDataIsPersistedBetweenDataStoreInstances() {
        ...
        // Then
        ATAssertReflectionEqual(result?.data(), "value".utf8Data)
    }
