...
class ATTracerTests: XCTestCase {
    ...
    func testInjectingSpanContextToValidCarrierAndFormat() throws {
        ...
        let objcSpanContext = objc_SpanContextObjc(
            swiftSpanContext: ATSpanContext.mockWith(traceID: .init(idHi: 10, idLo: 100), spanID: 200, samplingDecision: .autoKept())
        )
    ...
    func testInjectingRejectedSpanContextToValidCarrierAndFormat() throws {
        ...
        let objcTracer = objc_Tracer.shared()
        let objcSpanContext = objc_SpanContextObjc(
            swiftSpanContext: ATSpanContext.mockWith(traceID: .init(idHi: 10, idLo: 100), spanID: 200)
        )
    ...
    func testInjectingSpanContextToInvalidCarrierOrFormat() throws {
        Trace.enable(with: config)
        let objcTracer = objc_Tracer.shared()
        let objcSpanContext = objc_SpanContextObjc(swiftSpanContext: ATSpanContext.mockWith(traceID: .init(idHi: 10, idLo: 100), spanID: 200))
