...
internal extension XCTestCase {
    ...
    func ATAssertSnapshotTest(
        ...
        ATAssertSimulatorDevice(simulator, file: file, line: line)

        if record {
            ATSaveSnapshotIfDifferent(image: newImage, into: snapshotLocation, file: file, line: line)
            XCTFail(
            ...
            ATAssertSnapshotEquals(snapshotLocation: snapshotLocation, image: newImage, file: file, line: line)
        }
    }

    /// Asserts that tests are executed on given iOS Simulator.
    private func ATAssertSimulatorDevice(_ simulator: SnapshotSimulator, file: StaticString = #filePath, line: UInt = #line) {
    ...
    private func ATSaveSnapshotIfDifferent(image: UIImage, into location: ImageLocation, file: StaticString = #filePath, line: UInt = #line) {
    ...
    private func ATAssertSnapshotEquals(snapshotLocation: ImageLocation, image: UIImage, file: StaticString = #filePath, line: UInt = #line) {
