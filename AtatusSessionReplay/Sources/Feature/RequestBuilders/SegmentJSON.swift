...
internal struct SegmentJSON {
    enum Constants {
        ...
        /// see. https://github.com/dd/rum-events-format/blob/master/schemas/session-replay/common/_common-record-schema.json#L9
        static let timestampKey = "timestamp"
        /// The `type` key can be used to identify the type of record.
        static let typeKey = "type"
        /// The constant type value for browser full snapshot is `2`.
        /// see. https://github.com/dd/rum-events-format/blob/master/schemas/session-replay/browser/full-snapshot-record-schema.json#L14L19
        static let browserFullsnapshotValue = 2
        /// The constant type value for mobile full snapshot is `10`.
        /// see. https://github.com/dd/rum-events-format/blob/master/schemas/session-replay/mobile/full-snapshot-record-schema.json#L14L19
