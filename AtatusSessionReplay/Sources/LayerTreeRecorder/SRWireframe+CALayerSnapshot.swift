...
extension SRWireframe {
    ...
    init?(
        ...
        self = .shapeWireframe(
            value: .init(
                ...
                x: Int64.atWithNoOverflow(layerSnapshot.absoluteFrame.minX),
                y: Int64.atWithNoOverflow(layerSnapshot.absoluteFrame.minY),
                width: Int64.atWithNoOverflow(dimension: layerSnapshot.absoluteFrame.width),
                height: Int64.atWithNoOverflow(dimension: layerSnapshot.absoluteFrame.height),
    ...
    init(
        ...
        self = .imageWireframe(
            value: .init(
                replayID: replayID,
                x: Int64.atWithNoOverflow(imageSnapshot.frame.minX),
                y: Int64.atWithNoOverflow(imageSnapshot.frame.minY),
                width: Int64.atWithNoOverflow(dimension: imageSnapshot.frame.width),
                height: Int64.atWithNoOverflow(dimension: imageSnapshot.frame.height),
                isEmpty: false,
    ...
    init(
        ...
        self = .webviewWireframe(
            value: .init(
                border: .init(layerSnapshot: layerSnapshot),
                height: Int64.atWithNoOverflow(dimension: webView.slotFrame.height),
                id: Int64(webView.slotID),
                isVisible: true,
                shapeStyle: .init(layerSnapshot: layerSnapshot),
                slotId: String(webView.slotID),
                width: Int64.atWithNoOverflow(dimension: webView.slotFrame.width),
                x: Int64.atWithNoOverflow(webView.slotFrame.minX),
                y: Int64.atWithNoOverflow(webView.slotFrame.minY)
            )
        )
    }
}
...
extension SRTextStyle {
    ...
    fileprivate init(
        ...
        var fontSize = Int64.atWithNoOverflow(label.font?.pointSize ?? .fallbackFontSize)
...
extension SRShapeBorder {
    ...
    fileprivate init?(layerSnapshot: CALayerSnapshot) {
        ...
        self.init(
            ...
            width: Int64.atWithNoOverflow(layerSnapshot.borderWidth.rounded(.up))
        )
    }
}
