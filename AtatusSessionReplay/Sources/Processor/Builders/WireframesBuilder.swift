...
extension SessionReplayWireframesBuilder {
    ...
    public func createShapeWireframe(
        ...
        let wireframe = SRShapeWireframe(
            ...
            height: Int64.atWithNoOverflow( frame.height),
            id: id,
            ...
            width: Int64.atWithNoOverflow( frame.width),
            x: Int64.atWithNoOverflow( frame.minX),
            y: Int64.atWithNoOverflow( frame.minY)
        )
    ...
    public func createTextWireframe(
        ...
        let textPosition = SRTextPosition(
            ...
            padding: .init(
                bottom: Int64.atWithNoOverflow( frame.maxY - textFrame.maxY),
                left: Int64.atWithNoOverflow( textFrame.minX - frame.minX),
                right: Int64.atWithNoOverflow( frame.maxX - textFrame.maxX),
                top: Int64.atWithNoOverflow( textFrame.minY - frame.minY)
            )
        )

        var fontSize = Int64.atWithNoOverflow( fontOverride?.size ?? font?.pointSize ?? Fallback.fontSize)
    ...
    public func createPlaceholderWireframe(
        ...
        let wireframe = SRPlaceholderWireframe(
            clip: SRContentClip(frame, intersecting: clip),
            height: Int64.atWithNoOverflow( frame.size.height),
            id: id,
            label: label,
            permanentId: heatmapIdentifier?.rawValue,
            width: Int64.atWithNoOverflow( frame.size.width),
            x: Int64.atWithNoOverflow( frame.minX),
            y: Int64.atWithNoOverflow( frame.minY)
        )
    ...
    private func createShapeBorder(borderColor: CGColor?, borderWidth: CGFloat?) -> SRShapeBorder? {
        ...
        return .init(
            ...
            width: Int64.atWithNoOverflow( borderWidth.rounded(.up))
        )
    }
...
extension SRContentClip {
    ...
    init?(_ frame: CGRect, intersecting clip: CGRect) {
        ...
        guard !intersection.isEmpty else {
            self.init(
                bottom: nil,
                left: Int64.atWithNoOverflow( frame.width),
                right: nil,
                top: Int64.atWithNoOverflow( frame.height)
            )
        ...
        self.init(
            bottom: bottom.isZero ? nil : Int64.atWithNoOverflow( bottom),
            left: left.isZero ? nil : Int64.atWithNoOverflow( left),
            right: right.isZero ? nil : Int64.atWithNoOverflow( right),
            top: top.isZero ? nil : Int64.atWithNoOverflow( top)
        )
    }
}
