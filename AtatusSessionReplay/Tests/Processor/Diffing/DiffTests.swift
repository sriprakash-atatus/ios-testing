...
class DiffTests: XCTestCase {
    ...
    func testDiffAgainstEqualSequenceShouldBeEmpty() throws {
        ...
        // Then
        ATAssertReflectionEqual(diff.adds, [])
        ATAssertReflectionEqual(diff.updates, [])
        ATAssertReflectionEqual(diff.removes, [])
    ...
    func testDiffAgainstEmptySequenceShouldGiveOnlyRemovals() throws {
        ...
        ATAssertReflectionEqual(diff.adds, [])
        ATAssertReflectionEqual(diff.updates, [])
        ATAssertReflectionEqual(diff.removes, [.init(id: 1), .init(id: 2), .init(id: 3)])
        XCTAssertFalse(diff.isEmpty)
    }
    ...
    func testAddingElementsAtTheEnd() throws {
        ...
        ATAssertReflectionEqual(diff.adds[0], Diff.Add(previousID: 3, new: Mock(id: 4)))
        ATAssertReflectionEqual(diff.adds[1], Diff.Add(previousID: 4, new: Mock(id: 5)))
        ATAssertReflectionEqual(diff.updates, [])
        ATAssertReflectionEqual(diff.removes, [])
    }
    ...
    func testAddingElementsAtTheBeginning() throws {
        ...
        // Then
        XCTAssertEqual(diff.adds.count, 2)
        ATAssertReflectionEqual(diff.adds[0], Diff.Add(previousID: nil, new: Mock(id: 4)))
        ATAssertReflectionEqual(diff.adds[1], Diff.Add(previousID: 4, new: Mock(id: 5)))
        ATAssertReflectionEqual(diff.updates, [])
        ATAssertReflectionEqual(diff.removes, [])
    }
    ...
    func testAddingElementsInTheMiddle() throws {
        ...
        // Then
        XCTAssertEqual(diff.adds.count, 2)
        ATAssertReflectionEqual(diff.adds[0], Diff.Add(previousID: 1, new: Mock(id: 4)))
        ATAssertReflectionEqual(diff.adds[1], Diff.Add(previousID: 2, new: Mock(id: 5)))
        ATAssertReflectionEqual(diff.updates, [])
        ATAssertReflectionEqual(diff.removes, [])
    }
    ...
    func testChangingOrderOfElementsAtTheBeginning() throws {
        ...
        // Then
        XCTAssertEqual(diff.adds.count, 2)
        ATAssertReflectionEqual(diff.adds[0], Diff.Add(previousID: nil, new: Mock(id: 2)))
        ATAssertReflectionEqual(diff.adds[1], Diff.Add(previousID: 2, new: Mock(id: 1)))
        ATAssertReflectionEqual(diff.updates, [])
    ...
    func testChangingOrderOfElementsAtTheEnd() throws {
        ...
        // Then
        XCTAssertEqual(diff.adds.count, 2)
        ATAssertReflectionEqual(diff.adds[0], Diff.Add(previousID: 1, new: Mock(id: 3)))
        ATAssertReflectionEqual(diff.adds[1], Diff.Add(previousID: 3, new: Mock(id: 2)))
        ATAssertReflectionEqual(diff.updates, [])
    ...
    func testChangingOrderOfAllElements() throws {
        ...
        ATAssertReflectionEqual(diff.adds[0], Diff.Add(previousID: nil, new: Mock(id: 2)))
        ATAssertReflectionEqual(diff.adds[1], Diff.Add(previousID: 2, new: Mock(id: 3)))
        ATAssertReflectionEqual(diff.adds[2], Diff.Add(previousID: 3, new: Mock(id: 1)))
        ATAssertReflectionEqual(diff.updates, [])
    ...
    func testUpdatingElementsAtTheBeginning() throws {
        ...
        // Then
        ATAssertReflectionEqual(diff.adds, [])
        ATAssertReflectionEqual(diff.updates, [.init(from: sequenceA[0], to: sequenceB[0])])
        ATAssertReflectionEqual(diff.removes, [])
    }
    ...
    func testUpdatingElementsAtTheEnd() throws {
        ...
        // Then
        ATAssertReflectionEqual(diff.adds, [])
        ATAssertReflectionEqual(diff.updates, [.init(from: sequenceA[2], to: sequenceB[2])])
        ATAssertReflectionEqual(diff.removes, [])
    }
    ...
    func testUpdatingElementsInTheMiddle() throws {
        ...
        // Then
        ATAssertReflectionEqual(diff.adds, [])
        ATAssertReflectionEqual(diff.updates, [.init(from: sequenceA[1], to: sequenceB[1])])
        ATAssertReflectionEqual(diff.removes, [])
    }
