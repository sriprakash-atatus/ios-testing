...
// `ddSessionReplay` -> `AtatusSessionReplay`; renamed the `DD` symbol prefix to `AT`; renamed `dd*`
...
class ATSessionReplayOverrideTests: XCTestCase {
    ...
    func testHidePrivacyLevelsOverrideInterop() {
        ...
        let view = UIView()
        let objcOverrides = view.atSessionReplayPrivacyOverrides
    ...
    func testSettingAndClearingViewOverridesInObjc() {
        ...
        // When
        view.atSessionReplayPrivacyOverrides.textAndInputPrivacy = textAndInputPrivacy
        view.atSessionReplayPrivacyOverrides.imagePrivacy = imagePrivacy
        view.atSessionReplayPrivacyOverrides.touchPrivacy = touchPrivacy
        view.atSessionReplayPrivacyOverrides.hide = hidePrivacy

        // Then
        XCTAssertEqual(view.atSessionReplayPrivacyOverrides.textAndInputPrivacy, textAndInputPrivacy)
        XCTAssertEqual(view.atSessionReplayPrivacyOverrides.imagePrivacy, imagePrivacy)
        XCTAssertEqual(view.atSessionReplayPrivacyOverrides.touchPrivacy, touchPrivacy)
        XCTAssertEqual(view.atSessionReplayPrivacyOverrides.hide, hidePrivacy)

        // When
        view.atSessionReplayPrivacyOverrides.textAndInputPrivacy = .none
        view.atSessionReplayPrivacyOverrides.imagePrivacy = .none
        view.atSessionReplayPrivacyOverrides.touchPrivacy = .none
        view.atSessionReplayPrivacyOverrides.hide = nil

        // Then
        XCTAssertEqual(view.atSessionReplayPrivacyOverrides.textAndInputPrivacy, .none)
        XCTAssertEqual(view.atSessionReplayPrivacyOverrides.imagePrivacy, .none)
        XCTAssertEqual(view.atSessionReplayPrivacyOverrides.touchPrivacy, .none)
    ...
    func testReleasingOverridesWhenViewIsDeallocated() {
        ...
        autoreleasepool {
            let tempView = UIView()
            view = tempView
            tempView.atSessionReplayPrivacyOverrides.textAndInputPrivacy = .mockRandom()
            tempView.atSessionReplayPrivacyOverrides.imagePrivacy = .mockRandom()
            tempView.atSessionReplayPrivacyOverrides.touchPrivacy = .mockRandom()
            tempView.atSessionReplayPrivacyOverrides.hide = NSNumber.mockRandomBoolean()
        }

        XCTAssertNil(view?.atSessionReplayPrivacyOverrides.textAndInputPrivacy)
        XCTAssertNil(view?.atSessionReplayPrivacyOverrides.imagePrivacy)
        XCTAssertNil(view?.atSessionReplayPrivacyOverrides.touchPrivacy)
        XCTAssertNil(view?.atSessionReplayPrivacyOverrides.hide)
    }
}
#endif
