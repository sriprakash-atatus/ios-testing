...
internal struct ATSpanContext: OTSpanContext {
    ...
    /// Delegate method called by ``ATSpan.setTag(key:value:)`` that filters and runs custom actions for specific tags.
    ///
    ...
    func span(_ span: ATSpan, willSetTagWithKey key: String, value: Encodable) -> Bool {
...
internal class BaggageItems: @unchecked Sendable {
    /// Baggage items of the parent `ATSpan` or`nil` for items of the root span.
