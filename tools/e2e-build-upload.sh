...
create_xcconfig() {
    ...
    get_secret $AT_IOS_SECRET__E2E_XCCONFIG_BASE64 | base64 --decode -o $E2E_XCCONFIG_PATH
...
create_codesign_files() {
    ...
    get_secret $AT_IOS_SECRET__E2E_PROVISIONING_PROFILE_BASE64 | base64 --decode -o $PP_PATH
