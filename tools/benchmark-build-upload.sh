...
create_xcconfig() {
    ...
    get_secret $AT_IOS_SECRET__BENCHMARK_XCCONFIG_BASE64 | base64 --decode -o $BENCHMARK_XCCONFIG_PATH
...
create_codesign_files() {
    ...
    get_secret $AT_IOS_SECRET__DEV_CERTIFICATE_P12_BASE64 | base64 --decode -o $P12_PATH
    echo_succ "▸ $P12_PATH - ready"
    get_secret $AT_IOS_SECRET__BENCHMARK_PROVISIONING_PROFILE_BASE64 | base64 --decode -o $PP_PATH
...
keychain_import \
    --p12 $P12_PATH \
    --p12-password $(get_secret "$AT_IOS_SECRET__DEV_CERTIFICATE_P12_PASSWORD")
...
if [ "$DRY_RUN" = "1" ] || [ "$DRY_RUN" = "true" ]; then
    ...
    export S8S_APPLICATION_ID=$(get_secret $AT_IOS_SECRET__BENCHMARK_S8S_APPLICATION_ID)
